function imager2(path_uv_data, param_general, runID)
    ...
    param_weighting.weight_type = param_general.weight_type;

    %% Call the function to generate the weights
    if param_weighting.weighting_on && strcmp(param_weighting.weight_type, 'uniform') || strcmp(param_weighting.weight_type, 'briggs')
